    ...
    module RefreshParserCommon
      module OrchestrationStacks
        ...
        def detailed_stacks(show_nested = true)
          ...
          if @ems.kind_of?(ManageIQ::Providers::Telefonica::CloudManager) && telefonica_heat_global_admin?
        ...
        def parse_stack_template(stack)
          ...
          template_type = "ManageIQ::Providers::Telefonica::CloudManager::OrchestrationTemplate"
