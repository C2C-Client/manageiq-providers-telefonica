class ManageIQ::Providers::Telefonica::Inventory::Parser::StorageManager::CinderManager < ManageIQ::Providers::Telefonica::Inventory::Parser
  def parse
    cloud_volumes
  ...
  def cloud_volumes
    collector.cloud_volumes.each do |v|
      ...
      volume.type = "ManageIQ::Providers::Telefonica::CloudManager::CloudVolume"
  ...
  def cloud_volume_snapshots
    collector.cloud_volume_snapshots.each do |s|
      ...
      snapshot.type = "ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeSnapshot"
  ...
  def cloud_volume_backups
    collector.cloud_volume_backups.each do |b|
      ...
      backup.type = "ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeBackup"
  ...
  def cloud_volume_types
    collector.cloud_volume_types.each do |t|
      ...
      volume_type.type = "ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeType"
