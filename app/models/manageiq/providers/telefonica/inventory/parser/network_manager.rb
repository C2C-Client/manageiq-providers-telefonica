class ManageIQ::Providers::Telefonica::Inventory::Parser::NetworkManager < ManageIQ::Providers::Telefonica::Inventory::Parser
  ...
  def cloud_networks
    collector.cloud_networks.each do |n|
      ...
      network.type = "ManageIQ::Providers::Telefonica::NetworkManager::CloudNetwork" + network_type_suffix
      network.name = n["name"]
  ...
  def cloud_subnets
    collector.cloud_subnets.each do |s|
      ...
      subnet.type = "ManageIQ::Providers::Telefonica::NetworkManager::CloudSubnet"
      subnet.name = s.name
      subnet.cidr = s.cidr
  ...
  def floating_ips
    collector.floating_ips.each do |f|
      ...
      floating_ip.type = "ManageIQ::Providers::Telefonica::NetworkManager::FloatingIp"
  ...
  def network_ports
    collector.network_ports.each do |np|
      ...
      network_port.type = "ManageIQ::Providers::Telefonica::NetworkManager::NetworkPort"
  ...
  def network_routers
    collector.network_routers.each do |nr|
      ...
      network_router.type = "ManageIQ::Providers::Telefonica::NetworkManager::NetworkRouter"
  ...
  def security_groups
    collector.security_groups.each do |s|
      ...
      security_group.type = "ManageIQ::Providers::Telefonica::NetworkManager::SecurityGroup"
