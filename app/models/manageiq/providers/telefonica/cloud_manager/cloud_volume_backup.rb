class ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeBackup < ::CloudVolumeBackup
  ...
  def raw_restore(volumeid = nil, name = nil)
    ...
    raise MiqException::MiqTelefonicaApiRequestError, parse_error_message_from_fog_response(e), e.backtrace
  end
