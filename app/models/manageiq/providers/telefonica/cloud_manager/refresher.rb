module ManageIQ::Providers
  class Telefonica::CloudManager::Refresher < ManageIQ::Providers::BaseManager::Refresher
    ...
    def preprocess_targets
      ...
      cloud_manager_ids = @targets_by_ems_id.keys.select { |key| @ems_by_ems_id[key].kind_of? ManageIQ::Providers::Telefonica::CloudManager }
