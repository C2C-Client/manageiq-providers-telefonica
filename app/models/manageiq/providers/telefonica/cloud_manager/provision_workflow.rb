class ManageIQ::Providers::Telefonica::CloudManager::ProvisionWorkflow < ::MiqProvisionCloudWorkflow
  ...
  def allowed_instance_types(_options = {})
    ...
    if source.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::VolumeTemplate) || source.kind_of?(ManageIQ::Providers::Telefonica::CloudManager::VolumeSnapshotTemplate)
  ...
  def dialog_name_from_automate(message = 'get_dialog_name')
    super(message, {'platform' => 'telefonica'})
  end
