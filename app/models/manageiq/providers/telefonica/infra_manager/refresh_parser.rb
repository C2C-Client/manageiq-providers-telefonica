module ManageIQ
  module Providers
    class Telefonica::InfraManager::RefreshParser < ManageIQ::Providers::InfraManager::RefreshParser
      ...
      def parse_host(host, indexed_servers, indexed_resources, cloud_hosts_attributes)
        ...
        new_result = {
          :name                 => host_name,
          :type                 => 'ManageIQ::Providers::Telefonica::InfraManager::Host',
          :uid_ems              => uid,
          :ems_ref              => uid,
      ...
      def process_host_hardware(host, introspection_details)
...

        {
          ...
          # fog-telefonica baremetal service defaults to Ironic API v1.1.
          ...
          # https://github.com/fog/fog-telefonica/issues/197
      ...
      def parse_cluster(cluster)
        ...
        new_result = {
          ...
          :uid_ems => uid,
          :name    => name,
          :type    => 'ManageIQ::Providers::Telefonica::InfraManager::EmsCluster'
        }
        return uid, new_result
      end
      ...
      def self.miq_template_type
        "ManageIQ::Providers::Telefonica::InfraManager::Template"
      end
