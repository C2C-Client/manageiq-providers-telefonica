module ManageIQ::Providers::Telefonica::InfraManager::Host::Operations
  ...
  def ironic_set_power_state(power_state = "power off")
    ...
    raise MiqException::MiqTelefonicaInfraHostSetPowerStateError, parse_error_message_from_fog_response(e), e.backtrace
  end
end
