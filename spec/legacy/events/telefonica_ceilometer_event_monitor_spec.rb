require 'manageiq/providers/telefonica/legacy/events/telefonica_ceilometer_event_monitor'

describe TelefonicaCeilometerEventMonitor do
  ...
  context "collecting events" do
    ...
    it 'query ceilometer new event' do
      ...
      subject.each_batch do |events|
        ...
        expect(events.first.class.name).to eq 'TelefonicaEvent'
