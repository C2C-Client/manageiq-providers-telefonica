describe ManageIQ::Providers::Telefonica::InfraManager::OrchestrationStack do
  ...
  let(:orchestration_stack) do
    FactoryBot.create(:orchestration_stack_telefonica_infra, :ext_management_system => ems, :name => 'test', :ems_ref => 'one_id')
  end
