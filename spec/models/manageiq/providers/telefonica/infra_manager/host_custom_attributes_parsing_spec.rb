describe ManageIQ::Providers::Telefonica::InfraManager::Host do
  #####################################################################
  ##### Variations of nice format  presetn in TeleFonica's confs #######
  let(:filesystem_telefonica_conf_nice) do
    <<-EOT
[DEFAULT]
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_ignore_header) do
    <<-EOT
[DEFAULT]
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_random_spaces) do
    <<-EOT
  [DEFAULT]
...
#novncproxy_base_url  =http://127.0.0.1:6080/vnc_auto.html
 novncproxy_base_url   =  http://0.0.0.0:6089/vnc_auto.html
  ...
  let(:filesystem_telefonica_conf_just_default_value) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_gets_last_occurrence_of_defined_attr) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_not_supported_colon_as_delimiter) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_continuation_line) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_commented_attribute_continuation_line) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_commented_continuation_line) do
    <<-EOT
[DEFAULT]
# Location of VNC console proxy, in the form
# "http://127.0.0.1:6080/vnc_auto.html" (string value)
...
test=test_value
  ...
  let(:filesystem_telefonica_conf_interpolation_all) do
    <<-EOT
[DEFAULT]
...
#image_cache_subdirectory_name = nova
  ...
  let(:filesystem_telefonica_conf_interpolation_missing_links) do
    <<-EOT
[DEFAULT]
#
# Options defined in nova.virt.libvirt.imagecache
...
#image_info_filename_pattern=$instances_path/${image_cache_subdirectory_name}/%(image)s.info
  ...
  let(:filesystem_telefonica_conf_interpolation_infinite_cycle) do
    <<-EOT
[DEFAULT]
# Allows image information files to be stored in non-standard
# locations (string value)
...
#instances_path=$image_info_filename_pattern
  ...
  #######################################################################################
  ##### Complex formats not preset in Telefonica conf files, but defined in parser #######
  ...
  let(:filesystem_telefonica_conf_complex_example) do
    <<-EOT
  ...
  describe "#refresh_custom_attributes_from_conf_files" do
    let(:host) do
      FactoryBot.create(:host_telefonica_infra).tap do |host|
        host.system_services << FactoryBot.create(:system_service, :name => 'telefonica-nova')
      end
    end

    describe "parse telefonica conf nice format" do
      it "parses nice format" do
        files = [FactoryBot.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_nice)]
      ...
      it "ignores headers containing ====" do
        files = [FactoryBot.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_ignore_header)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks random spaces doesn't change the format" do
        files = [FactoryBot.create(:filesystem_telefonica_conf, :contents => filesystem_telefonica_conf_random_spaces)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks that only default value is present" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_just_default_value)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks that only last defined value is taken" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_gets_last_occurrence_of_defined_attr)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "check that colon as delimiter is not supported" do
        ...
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_not_supported_colon_as_delimiter)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "check that continuation line of value works" do
        # !!! This is change of the standard python parser
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_continuation_line)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "check that commented attr doesnt store continuation lines" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_commented_attribute_continuation_line)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "check that commented continuation line of value is not stored" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_commented_continuation_line)]
        host.refresh_custom_attributes_from_conf_files(files)
    ...
    describe "parse interpolated attributes" do
      it "checks all types of interpolation and nested interpolation" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_interpolation_all)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks not completed interpolation" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_interpolation_missing_links)]
        host.refresh_custom_attributes_from_conf_files(files)
      ...
      it "checks cycles in interpolation logs warning and ends" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_interpolation_infinite_cycle)]
        host.refresh_custom_attributes_from_conf_files(files)
    ...
    describe "parse complex Python configparser examples" do
      it "parses complex continuation line example" do
        files = [FactoryBot.create(:filesystem_telefonica_conf,
                                    :contents => filesystem_telefonica_conf_complex_example)]
        host.refresh_custom_attributes_from_conf_files(files)
