describe ManageIQ::Providers::Telefonica::CloudManager::OrchestrationStack do
  ...
  let(:orchestration_stack) do
    FactoryBot.create(:orchestration_stack_telefonica,
  ...
  describe '.transform_parameters' do
    let(:template) { FactoryBot.create(:orchestration_template_telefonica_in_yaml) }
