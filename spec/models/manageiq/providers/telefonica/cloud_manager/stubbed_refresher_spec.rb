...
describe ManageIQ::Providers::Telefonica::CloudManager::Refresher do
  ...
  describe "refresh" do
    ...
    def refresh_spec
      ...
      #c2c-provider: added to_s due to getting implicit conversion error in rspec
      EmsRefresh.refresh(@ems.to_s)
      # end
      @ems.reload
    ...
    def assert_table_counts
      ...
      expect(actual) == expected_table_counts
    end
    ...
    def assert_ems
      ...
      expect(ems.flavors.size) == (expected_table_counts[:flavor])
      expect(ems.availability_zones.size) == (expected_table_counts[:availability_zone])
      expect(ems.vms_and_templates.size) == (expected_table_counts(0)[:vm_or_template])
      expect(ems.miq_templates.size) == (expected_table_counts(0)[:miq_template])
      expect(ems.orchestration_stacks.size) == (expected_table_counts[:orchestration_stack])
    end
  end
end
