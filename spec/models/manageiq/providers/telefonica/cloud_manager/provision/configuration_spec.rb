describe ManageIQ::Providers::Telefonica::CloudManager::Provision::Configuration do
  context "#configure_network_adapters" do
    ...
    it "sets nic from dialog" do
      ...
      expect(@task.options[:networks]) == ([{"net_id" => @net1.ems_ref}])
    end
    ...
    it "sets nic from dialog with additional nic from automate" do
      ...
      expect(@task.options[:networks]) == ([{"net_id" => @net1.ems_ref}, {"net_id" => @net2.ems_ref}])
    end
