describe ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeSnapshot do
  ...
  let(:cloud_volume_snapshot) do
    FactoryBot.create(:cloud_volume_snapshot_telefonica,
                      :ext_management_system => ems,
                      :name                  => 'test',
                      :ems_ref               => 'cloud_id',
                      :cloud_tenant          => tenant,
  ...
  describe 'snapshot actions' do
    context ".create_snapshot" do
      ...
      it 'creates a snapshot' do
        ...
        snapshot = ManageIQ::Providers::Telefonica::CloudManager::CloudVolumeSnapshot
